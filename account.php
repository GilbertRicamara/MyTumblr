        ...
        <div class="bg-white shadow rounded overflow-hidden">
            ...
            <div class="px-4 py-3">
                ...
                <div class="p-4 rounded shadow-sm bg-light">
                    ...
                    <p class="font-italic mb-0">Vexel Artist</p>
                    <p class="font-italic mb-0">Open for Commissions</p>
                </div>
            </div>
            ...
            <div class="py-4 px-4">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-2 pl-lg-1"><img src="images/image3.jpg" alt="" class="img-fluid rounded shadow-sm"></div>                
